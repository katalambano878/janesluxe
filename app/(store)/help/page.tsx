      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#D7A7A0]/10 rounded-full mx-auto mb-4">
                <i className="ri-customer-service-2-line text-3xl text-[#D7A7A0]"></i>
              </div>
              ...
              <span className="text-[#D7A7A0] font-semibold whitespace-nowrap">Create Ticket →</span>
            </Link>
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#D7A7A0]/10 rounded-full mx-auto mb-4">
                <i className="ri-arrow-left-right-line text-3xl text-[#D7A7A0]"></i>
              </div>
              ...
              <span className="text-[#D7A7A0] font-semibold whitespace-nowrap">Initiate Return →</span>
            </Link>

...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can request changes within 1 hour of placing your order. Contact support immediately at YOUR_PHONE_NUMBER or hello@yourdomain.com. Once processing starts, changes may be limited."
    },
    {
      category: 'orders',

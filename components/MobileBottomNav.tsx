  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Top shadow gradient */}
        <div className="absolute -top-6 left-0 right-0 h-6 bg-gradient-to-t from-brand-ivory/90 to-transparent pointer-events-none" />
        
        <div className="bg-brand-ivory/80 backdrop-blur-xl border-t border-white/50 shadow-[0_-4px_24px_rgba(107,82,70,0.08)] supports-[backdrop-filter]:bg-brand-ivory/60">
              ...
              return (
                <Link
                  ...
                  className={`flex flex-col items-center justify-center py-2 transition-all duration-200 relative group active:scale-90 ${
                    active ? 'text-brand-accent' : 'text-brand-text/45'
                  }`}
                ...
                >
                  ...
                  <div className="relative w-7 h-7 flex items-center justify-center">
                    ...
                    {item.badge !== undefined && item.badge > 0 && (
                      <span className="absolute -top-1.5 -right-2 min-w-[18px] h-[18px] bg-brand-accent text-brand-ivory text-[10px] font-bold rounded-full flex items-center justify-center px-1 shadow-sm animate-scale-in">
